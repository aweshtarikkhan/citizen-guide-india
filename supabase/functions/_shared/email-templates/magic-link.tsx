...
export const MagicLinkEmail = ({ confirmationUrl }: MagicLinkEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your Matdaan login link</Preview>
    <Body style={main}>
      <Container style={container}>
        <Heading style={h1}>Your Matdaan login link</Heading>
        <Text style={text}>
          Click the button below to log in securely to Matdaan.com. This link will expire shortly.
        </Text>
